## 🛠️ Contributing to ChainEvents 🛠️
...
Welcome, contributing to `chainevents` is easy!

1. Submit or comment your intent on an issue
2. We will try to respond quickly
3. Fork this repo (fork all branches)
4. Submit your PR against `main`
5. Address PR Review

## NOTE For ODBuild Contributions

1. All PR must be submitted again v2_develop branch

### Issue

Project tracking is done via GitHub [issues](https://github.com/mubarak23/chainevents-contracts/issues).
...
and voilà you're a `chainevents-` contributor.
