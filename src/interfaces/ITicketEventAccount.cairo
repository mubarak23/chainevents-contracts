...
pub trait ITicketEventAccount<TState> {
    ...
    // fn lock_ticket_event_account(ref self: TState, ticket_event_account_address: ContractAddress,
    // lock_until: u64);
    ...
    // Getters
// fn get_ticket_even_account(self: @TState, ticket_event_account_address: ContractAddress) ->
// Campaign;
// fn get_ticket_even_account_balance(self: @TState, ticket_event_account_address:
// ContractAddress) -> u256;
// fn is_ticket_event_account_locked(self: @TState, ticket_event_account_address:
